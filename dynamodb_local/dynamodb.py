        ...
        for korisnik in korisnici_duple:
            ...
            if item:
                ...
                if novi_brojevi:
                    ...
                    print(f"Ovi brojevi već postoje za korisnika {korisnicko_ime}!")
            else:
                ...
                print(f"Unesen novi korisnik {korisnicko_ime} u tablicu")
        
        return {"poruka": "Korisnici su uspješno uneseni ili ažurirani!"}
